...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Episode', path: '/episodes', entity: 'episode', service: AccessServiceEnum.PROJECT, icon: FiPlayCircle },
    { name: 'Playlist', path: '/playlists', entity: 'playlist', service: AccessServiceEnum.PROJECT, icon: FiList },
    { name: 'Podcast', path: '/podcasts', entity: 'podcast', service: AccessServiceEnum.PROJECT, icon: FiRadio },
    { name: 'Snippet', path: '/snippets', entity: 'snippet', service: AccessServiceEnum.PROJECT, icon: FiFileText },
